 ...
 <ul class="sidebar-menu ">
     ...
     <li><a class="btn-logout" href="?pg=setting"><i class="fas fa-user-cog"></i> <span>Setting</span></a></li>
     <li><a class="btn-logout" href="logout.php"><i class="fas fa-sign-out-alt"></i> <span>Logout</span></a></li>
     <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
         <button type="button" class="btn btn-primary btn-lg btn-block btn-icon-split" data-toggle="modal"
             data-target="#ppdb">
