...
<head>
    ...
    <title>SMK PARADIS | <?= $setting['nama_sekolah'] ?></title>
    <!-- META DISKRIPSI-->
                ...
                <nav class="navbar navbar-expand-lg navbar-light" id="navbar-header">
                    ...
                    <div class="collapse navbar-collapse" id="menu">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./login" id="link-jadwal">Login</a>
                            </li>
                                ...
                                <div class="carousel-item active">
                                    <div>
                                        ...
                                        <p data-animation="animated slideInRight" data-delay="1s">
                                            Aplikasi Penerimaan Peserta didik baru Tahun Pelajaran 2022/2023
                                            <?= $setting['nama_sekolah'] ?>.
                                        </p>
                                        <p data-animation="animated slideInRight" data-delay="2s">
                                            Pendaftaran Siswa dan Siswi Baru Tahun 2022 ini telah dibuka. Silahkan
                                            Segera Daftar dan lengkapi Formulir
                                        </p>
                                ...
                                <form id="form-login">
                                    <div class="form-group">
                                        ...
                                        <input type="text" onkeyup="this.value = this.value.toUpperCase()"
                                            class="form-control" name="username" placeholder="Masukkan NISN" required
                                            autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form-login">
                                        <div class="form-group">
                                            <span class="fa fa-user"></span>
                                            <input type="text" onkeyup="this.value = this.value.toUpperCase()"
                                                class="form-control" name="username" placeholder="Masukkan NISN"
                                ...
                                <div class="col-md-12 animated bounceInLeft">
                                    <div class="card">
                                        ...
                                        <form id="form-daftar">
                                            <div class="card-body">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="number" maxlength="10" class="form-control"
                                                            name="nisn" placeholder="NISN" autocomplete="off" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="nohp">NO HANDPHONE</label>
                                                        <input type="number" class="form-control" name="nohp"
                                                            placeholder="No HP Whatsapp" disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-footer">
                                                <button id='btnsimpan' type="submit"
                                                    class="btn btn-lg btn-primary">SIMPAN DATA</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
