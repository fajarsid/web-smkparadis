<ul class="sidebar-menu">
    ...
    <li><a class="nav-link" href="?pg=cetakkartu"><i class="fas fa-print"></i> <span>Cetak Kartu Pendaftaran</span></a>

    </li>

    <?php if ($siswa['status'] == 1) { ?>
    <li><a class="nav-link" href="?pg=df_ulang"><i class="fas fa-address-card   "></i> <span>Daftar Ulang</span><small
                class="label pull-right badge badge-danger">wajib</small></a></li>
    <?php } else { ?>
